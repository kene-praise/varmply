    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[#EDE9FF] text-[#7C3BED]">Draft</span>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div>
            ...
            <div className="border border-[#7C3BED] bg-[#EDE9FF]/30 rounded-lg px-3 py-2 text-xs text-[#0F0F1A] font-medium">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <div className="border border-[#E4E4EC] rounded-lg px-3 py-2 flex items-center gap-1.5">
                ...
                <span className="text-xs font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>₦500,000</span>
              </div>
            </div>
            <div>
              <label className="text-[10px] font-semibold text-[#4A4A6A] uppercase tracking-wide block mb-1">
              ...
              <div className="border border-[#E4E4EC] rounded-lg px-3 py-2">
                <span className="text-xs font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>₦25,000</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                <div key={i} className="flex items-center gap-2 bg-[#F7F7F9] rounded-md px-2.5 py-1.5">
                  <Target size={10} className="text-[#7C3BED]" />
